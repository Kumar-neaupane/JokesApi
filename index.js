...
app.put("/jokes/:id", (req, res) => {
  ...
  jokes[searchIndex] = { id, jokeText: req.body.text, jokeType: req.body.type };
  res.json(jokes[searchIndex]);
});

// Update (modify) a joke partially
app.patch("/jokes/:id", (req, res) => {
  ...
  existingJoke.jokeText = req.body.text || existingJoke.jokeText;
  existingJoke.jokeType = req.body.type || existingJoke.jokeType;
...
app.delete("/jokes/:id", (req, res) => {
  ...
  res.json({ message: `Joke with id ${id} deleted successfully.` });
});
